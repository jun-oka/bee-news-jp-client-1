...
module.exports = function() {
  return {
    test: function(req, res) {
        ...
        // スクレイピング開始(サイト１)
        client.fetch('http://honeybee-club.com/cgi/clip/clip.cgi', {}, function (err, $, res) {
            if(!err) {
        ...
        // スクレイピング開始(奈良スズメ)
        client.fetch('http://narasuzume.ryuon.org/protect_1/joyful003/joyful.cgi', {}, function (err, $, res) {
            if(!err) {
                ...
                //        console.error(err);
                //    } else {
                //        console.log("naraModel saved:" + nara)
                //    }
                //});
